...
| **Full Mock Exam** | Sit all four skills in sequence (Listening → Reading → Writing → Speaking) and get one overall band with the official rounding — a stepper-guided full exam simulation |
