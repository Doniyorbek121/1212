...
window.READING_TESTS = [
  ...
  {
    name: 'Test 4 - People & Progress',
    passages: [
  {
    title: 'The History of the Bicycle',
    intro: 'You should spend about 20 minutes on Questions 1-13.',
    paras: [
      ['A', "The bicycle is often taken for granted, yet its invention transformed how ordinary people moved through the world. The earliest ancestor of the modern bicycle appeared in Germany in 1817, when Baron Karl von Drais built a two-wheeled wooden machine that the rider pushed along with their feet. Known as the running machine, it had no pedals, but it proved that a person could balance on two wheels in line."],
      ['B', "For several decades the design changed slowly. In the 1860s, French inventors added pedals to the front wheel, creating a machine nicknamed the boneshaker because its iron frame and wooden wheels made for an extremely uncomfortable ride on cobbled streets. To go faster, makers then enlarged the front wheel dramatically, producing the famous penny-farthing, with its huge front wheel and tiny rear one."],
      ['C', "The penny-farthing was fast but dangerous. Riders sat high above the ground, and a sudden stop could throw them over the handlebars. Because of this, cycling remained largely a hobby for wealthy and adventurous young men. The machine that finally opened cycling to everyone was the safety bicycle of the 1880s, which had two equally sized wheels and a chain driving the rear wheel, much like bicycles today."],
      ['D', "The safety bicycle, combined with the invention of the air-filled rubber tyre, made riding comfortable and accessible. Prices fell as factories began mass production, and by the 1890s a cycling craze had swept Europe and North America. For the first time, people of modest means could travel several miles quickly and cheaply without a horse."],
      ['E', "The social effects were profound. The bicycle gave people, and especially women, a new freedom of movement. No longer dependent on others for transport, women could travel independently, and many historians link the bicycle to the growing campaign for women's rights at the turn of the century. Practical clothing designed for cycling also challenged the restrictive fashions of the time."],
      ['F', "Today, more than two hundred years after von Drais's wooden machine, the bicycle remains one of the most efficient forms of transport ever devised. As cities struggle with pollution and congestion, many are once again encouraging cycling, proving that this simple, elegant invention still has an important role to play."],
    ],
    groups: [
      { instr: 'Questions 1-5 - Do the statements agree with the information? Choose TRUE, FALSE or NOT GIVEN.', type: 'tfng',
        qs: [
          { n: 1, text: "Von Drais's early machine had no pedals.", a: 'TRUE' },
          { n: 2, text: 'The boneshaker was known for being comfortable to ride.', a: 'FALSE' },
          { n: 3, text: 'The penny-farthing was safer than earlier designs.', a: 'FALSE' },
          { n: 4, text: 'The safety bicycle sold more units than the penny-farthing.', a: 'NOT GIVEN' },
          { n: 5, text: 'The bicycle is linked to greater independence for women.', a: 'TRUE' },
        ] },
      { instr: 'Questions 6-9 - Complete each sentence with ONE WORD ONLY from the passage.', type: 'gap',
        qs: [
          { n: 6, text: "Von Drais's machine was called the running ______.", a: 'machine' },
          { n: 7, text: 'The boneshaker had pedals attached to the front ______.', a: 'wheel' },
          { n: 8, text: 'The safety bicycle used a ______ to drive the rear wheel.', a: 'chain' },
          { n: 9, text: 'The air-filled rubber ______ made riding comfortable.', a: 'tyre' },
        ] },
      { instr: 'Questions 10-13 - Which paragraph (A-F) contains the following information?', type: 'match', options: ['A','B','C','D','E','F'],
        qs: [
          { n: 10, text: 'The social impact of cycling on women.', a: 'E' },
          { n: 11, text: 'The very first two-wheeled machine.', a: 'A' },
          { n: 12, text: 'How mass production lowered prices.', a: 'D' },
          { n: 13, text: 'The dangers of riding the penny-farthing.', a: 'C' },
        ] },
    ],
  },
  {
    ...
    intro: 'You should spend about 20 minutes on Questions 14-26.',
    paras: [
      ['A', "Laughter is one of the most universal of human behaviours, found in every culture on Earth, yet it remains surprisingly poorly understood. We tend to think of laughter as a simple response to something funny, but scientists who study it have found that humour is only one of its many triggers, and often not the most important."],
      ['B', "One of the most striking findings is that laughter is fundamentally social. Studies show that people are far more likely to laugh in the company of others than when alone, even when watching or reading exactly the same material. Laughter, researchers argue, evolved primarily as a way of bonding with others and signalling that a situation is safe and playful, rather than as a reaction to jokes."],
      ['C', "This social function may explain why laughter is so contagious. Hearing others laugh activates regions of the brain that prepare our own facial muscles to join in, which is why recorded laughter is sometimes added to television comedies. It is very difficult to remain completely straight-faced when everyone around you is laughing helplessly."],
      ['D', "Laughter also appears to bring real physical benefits. It briefly increases the heart rate and then relaxes the muscles, and some studies suggest it can reduce levels of stress hormones. While claims that laughter can cure serious illness are exaggerated, there is reasonable evidence that a good laugh improves mood and helps people cope with pain and difficulty."],
      ['E', "Interestingly, humans are not the only animals that appear to laugh. When young chimpanzees and even rats are tickled or play together, they produce sounds that scientists consider to be a form of laughter. This suggests that the roots of laughter are very ancient, evolving long before humans developed language or a sense of humour as we understand it."],
      ['F', "Perhaps the most important lesson from this research is that laughter is less about jokes than about connection. The next time you share a laugh with a friend over something that would not seem funny to a stranger, you are taking part in one of the oldest and most powerful of all human social bonds."],
    ],
    groups: [
      { instr: 'Questions 14-18 - Do the statements agree with the views of the writer? Choose YES, NO or NOT GIVEN.', type: 'yynn',
        qs: [
          { n: 14, text: 'Humour is the main cause of laughter.', a: 'NO' },
          { n: 15, text: 'People laugh more when they are with others.', a: 'YES' },
          { n: 16, text: 'Recorded laughter makes comedies less popular.', a: 'NOT GIVEN' },
          { n: 17, text: 'Laughter can completely cure serious diseases.', a: 'NO' },
          { n: 18, text: 'Some animals produce sounds similar to laughter.', a: 'YES' },
        ] },
      { instr: 'Questions 19-22 - Complete the notes with ONE WORD ONLY from the passage.', type: 'gap',
        qs: [
          { n: 19, text: 'Laughter is fundamentally ______ rather than a reaction to jokes.', a: 'social' },
          { n: 20, text: 'Laughter is described as ______, spreading from person to person.', a: 'contagious' },
          { n: 21, text: 'A good laugh can reduce levels of stress ______.', a: 'hormones' },
          { n: 22, text: 'Young ______ produce laughter-like sounds when tickled.', a: 'chimpanzees' },
        ] },
      { instr: 'Questions 23-26 - Which paragraph (A-F) contains the following information?', type: 'match', options: ['A','B','C','D','E','F'],
        qs: [
          { n: 23, text: 'Evidence that laughter is very old in evolutionary terms.', a: 'E' },
          { n: 24, text: 'The physical effects of laughing on the body.', a: 'D' },
          { n: 25, text: 'Why laughter spreads easily between people.', a: 'C' },
          { n: 26, text: 'The main message that laughter is about connection.', a: 'F' },
        ] },
    ],
  },
  {
    title: 'Plastic and the Ocean',
    intro: 'You should spend about 20 minutes on Questions 27-40.',
    paras: [
      ['A', "Few environmental problems have captured public attention as quickly as ocean plastic. Every year, millions of tonnes of plastic waste enter the sea, carried by rivers, blown from landfills or dumped directly. Because most plastics do not break down for hundreds of years, this waste accumulates, threatening marine life and, ultimately, human health."],
      ['B', "The scale of the problem is hard to grasp. In several parts of the ocean, currents gather floating rubbish into vast patches, the largest of which covers an area many times the size of a small country. Yet the visible litter is only part of the story. Much of the plastic breaks into tiny fragments known as microplastics, which are now found everywhere from the deepest ocean trenches to the ice of the Arctic."],
      ['C', "The effects on wildlife are severe. Seabirds, turtles and whales mistake floating plastic for food and can starve with stomachs full of waste they cannot digest. Smaller creatures consume microplastics, which then pass up the food chain. Alarmingly, these particles have been detected in the fish and shellfish that humans eat, and even in drinking water."],
      ['D', "Tackling the problem is difficult because plastic is so useful and so cheap. It is lightweight, durable and hygienic, which is why it is used for everything from medical equipment to food packaging. Simply banning it entirely is neither realistic nor, in many cases, desirable. Instead, most experts call for a combination of approaches."],
      ['E', "The first priority, many argue, is to reduce the amount of single-use plastic we produce, such as bags, straws and packaging that are thrown away after a single use. The second is to improve recycling, since at present only a small fraction of plastic is actually recycled. A third approach is to develop new materials that break down harmlessly, although these are not yet a complete solution."],
      ['F', "Encouragingly, awareness is growing. Many governments have banned certain single-use items, businesses are redesigning packaging, and communities organise beach clean-ups around the world. The problem of ocean plastic took decades to create and will take decades to solve, but the direction of change, at last, appears to be positive."],
    ],
    groups: [
      { instr: 'Questions 27-30 - Choose the correct letter, A, B or C.', type: 'mcq',
        qs: [
          { n: 27, text: 'Most plastics are a problem because they', a: 'B',
            options: ['A. dissolve quickly in water.', 'B. take hundreds of years to break down.', 'C. are difficult to produce.'] },
          { n: 28, text: 'Microplastics have been found', a: 'C',
            options: ['A. only near large cities.', 'B. only on beaches.', 'C. from deep trenches to Arctic ice.'] },
          { n: 29, text: 'Banning plastic entirely is described as', a: 'A',
            options: ['A. unrealistic and often undesirable.', 'B. the best single solution.', 'C. already achieved in most countries.'] },
          { n: 30, text: 'The writer says only a small fraction of plastic is', a: 'C',
            options: ['A. produced.', 'B. thrown away.', 'C. actually recycled.'] },
        ] },
      { instr: 'Questions 31-35 - Do the statements agree with the passage? Choose TRUE, FALSE or NOT GIVEN.', type: 'tfng',
        qs: [
          { n: 31, text: 'Plastic waste enters the sea from several different sources.', a: 'TRUE' },
          { n: 32, text: 'Microplastics have been found in food that people eat.', a: 'TRUE' },
          { n: 33, text: 'Plastic is described as expensive and hard to use.', a: 'FALSE' },
          { n: 34, text: 'The largest ocean garbage patch is shrinking every year.', a: 'NOT GIVEN' },
          { n: 35, text: 'The writer is ultimately hopeful about progress.', a: 'TRUE' },
        ] },
      { instr: 'Questions 36-40 - Complete the summary with ONE WORD ONLY from the passage.', type: 'gap',
        qs: [
          { n: 36, text: 'Ocean currents gather rubbish into floating ______.', a: 'patches' },
          { n: 37, text: 'Plastic breaks into tiny fragments called ______.', a: 'microplastics' },
          { n: 38, text: 'Turtles and whales mistake plastic for ______.', a: 'food' },
          { n: 39, text: 'A key priority is reducing single-use ______.', a: 'plastic' },
          { n: 40, text: 'New ______ that break down harmlessly are being developed.', a: 'materials' },
        ] },
    ],
  },
    ],
